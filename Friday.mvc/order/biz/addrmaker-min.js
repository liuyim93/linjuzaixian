    ...
    function n() {
        ...
        l.on(o, "submit", function (z) {
           ...
           //debugger
            ...
            d({ url: "/Order/Home/addBuyerAddress?_input_charset=utf-8", type: "post", dataType: "json", data: { districtionName:_districtionName,cityName: _cityName, provinceName: _provinceName, province: _province, city: _city, distriction: _distriction, deliverPhoneBak: u, deliverPhone: v, deliverName: x, deliverAddress: w, postCode: y, divisionCode: t.dist || t.city, isDefaultDeliverAddress: false }, success: function (B) {
                if (1 !== B.is_success) {
                    i.isSubmiting = false;
