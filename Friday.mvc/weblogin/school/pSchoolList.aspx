<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pSchoolList.aspx.cs" Inherits="Friday.mvc.weblogin.pSchoolList" %>
...
<div class="panelBar">
    <ul id="dictreeToolBar" class="toolBar">
        <li><a id="addata" class="add" href="School/pAddSchool.aspx?flag=save&code=" target="dialog" rel=""><span>添加</span></a></li>
        <li id="liDelete" runat="server"><a class="delete" href="School/pSchoolList.aspx?flag=alldelete&code=" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            var node_click_url = "School/pEditSchool.aspx";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //d.url = "School/pSchoolList.aspx/GetSchool?t=" + (new Date().getTime());
