...
(function($){
			...
			$.ajax({
				...
				success: function(response){
					...
					if (json.statusCode==DWZ.statusCode.error){
                        ...
                        //2013-01-15 basilwang we need deal with pagination which can't use op.data.prefix directly
                        var prefix=op.data.prefix;
                        if(typeof prefix=="undefined")
                        {
                           var filters=$.grep(op.data, function(e){ return e.name == "prefix"; });
                           if(filters.length!=0)
	...
	$.extend(String.prototype, {
        ...
        //2013-01-15 basilwang add getDiscriminer
        getDiscriminer:function(){
            var discriminer = /.*discriminer=([^.&?]*)/ig.exec(this);
            discriminer = discriminer ? discriminer[1] : "";
            return discriminer;
        },
