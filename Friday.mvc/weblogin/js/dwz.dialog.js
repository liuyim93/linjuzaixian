...
(function ($) {
    $.pdialog = {
        ...
        open: function (url, dlgid, title, options) {
            ...
            if (dialog) {
                ...
                if (op.fresh || url != $(dialog).data("url")) {
                    ...
                    var jDContent = dialog.find(".dialogContent");
                    //2013-01-14 basilwang change {} to op.data
        ...
        //2013-01-14 basilwang getDialog by dlgid
        getDialog: function (dlgid) {
            var dialog = $("body").data(dlgid);
            return dialog;
        }
        ,
        //2013-01-15 basilwang getCurrentDialogPrefix 
        getCurrentDialogPrefix:function(){
            return this._current.data("id");
        }
        ,
        /**
        * 切换当前层
