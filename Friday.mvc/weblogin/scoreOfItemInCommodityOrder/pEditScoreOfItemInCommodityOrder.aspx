<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pEditScoreOfItemInCommodityOrder.aspx.cs" Inherits="Friday.mvc.weblogin.scoreOfItemInCommodityOrder.pEditScoreOfItemInCommodityOrder" %>
    ...
    <form id="form" method="post" class="pageForm required-validate" enctype="multipart/form-data" runat="server">
        ...
        <div defh="95">
            ...
            <p>
                ...
                <a class="btnLook" href="ListValuingItemOfMyCommodityOrder.aspx" rel="" lookupgroup="">选择评价项</a>
            </p>
            <p>
            <label>
                    评分:</label>
