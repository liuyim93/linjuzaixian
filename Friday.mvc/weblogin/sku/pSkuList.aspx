...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="add" href="Address/pAddAddress.aspx?systemUser_id=<%=Request.Params["systemUser_id"]%>" title="增加商品种类" target="dialog"
            rel=""><span>增加商品种类</span></a></li>
        <li><a class="edit" href="Address/pEditAddress.aspx?uid={addressid}" title="修改商品种类" rel="" target="dialog"><span>修改商品种类</span></a></li>
