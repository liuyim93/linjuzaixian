  ...
  <ul>
    ...
    <div class="user_main_box">
        <ul>
          ...
          <li class="user_main_input"><input class="TxtUserNameCssClass" id="account"  maxlength="20" name="account"/> </li>
        </ul>
        <ul>
        ...
        <ul style="display:none">
          ...
          <li class="user_main_input"><input class="TxtYanzheng" id="userauthcode" name="userauthcode"/> </li>
          <li>
    ...
    <li class="user_main_r"><input type="submit" value="登录" /></li>
