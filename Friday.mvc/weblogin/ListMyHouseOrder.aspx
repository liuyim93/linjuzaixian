<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListMyHouseOrder.aspx.cs" Inherits="Friday.mvc.weblogin.ListMyHouseOrder" %>
        ...
        <asp:repeater id="repeater" runat="server">
                ...
                <ItemTemplate>                
                    <tr target="userid" rel="<%#Eval("Id")%>">
                        ...
                        <td>
				    <a class="btnSelect" href=javascript:$.bringBack({OrderID:'<%#DataBinder.Eval(Container.DataItem,"Id")%>',OrderNumber:'<%#DataBinder.Eval(Container.DataItem,"OrderNumber")%>',Price:'<%#DataBinder.Eval(Container.DataItem,"Price")%>',LoginName:'<%#DataBinder.Eval(Container.DataItem,"SystemUser.LoginUser.LoginName")%>',MerchantName:'<%#DataBinder.Eval(Container.DataItem,"Rent.Name")%>'}) title="查找带回">选择</a>
				        </td>				
			        </tr>
            </ItemTemplate>
        </asp:repeater>
