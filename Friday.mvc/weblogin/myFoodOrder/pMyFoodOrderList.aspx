<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pMyFoodOrderList.aspx.cs" Inherits="Friday.mvc.weblogin.pMyFoodOrderList" %>
...
<div class="panelBar">
    <ul class="toolBar">
        <li id="liAdd" runat="server"><a class="add" href="myFoodOrder/pAddMyFoodOrder.aspx" title="添加订单" target="navTab" rel=""><span>
            添加订单</span></a></li>
    ...
    <table class="table" layouth="440">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="myFoodOrder/pMyFoodOrderDetail.aspx?uid=<%#Eval("Id")%>" target="ajax" prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox3"><%#Eval("OrderNumber")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            debugger
            o.find("#MyFoodOrderList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
