<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pValuingOfMyFoodOrderList.aspx.cs" Inherits="Friday.mvc.weblogin.valuingOfMyFoodOrder.pValuingOfMyFoodOrderList" %>
...
<div id="ValuingOfMyFoodOrderList">
    <table class="table" layouth="440">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="valuingOfMyFoodOrder/pValuingOfMyFoodOrderDetail.aspx?uid=<%#Eval("Id")%>&MyFoodOrderId=<%#Eval("MyFoodOrder.Id")%>" target="ajax" prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox3"><%#Eval("MyFoodOrder.OrderNumber")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            debugger
            o.find("#ValuingOfMyFoodOrderList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
