<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pValuingOfMyFoodOrderDetail.aspx.cs" Inherits="Friday.mvc.weblogin.valuingOfMyFoodOrder.pValuingOfMyFoodOrderDetail" %>
    ...
    <div class="tabsHeader">
        <div class="tabsHeaderContent">
          <ul>
                ...
                <li><a href='orderOfFood/pOrderOfFoodList.aspx?myFoodOrder_id=<%= Request.Params["MyFoodOrderId"]%>' prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox1"
                target="ajax"><span>订单明细</span></a></li>
                <li><a href='scoreOfItemInFoodOrder/pScoreOfItemInFoodOrderList.aspx?valuingOfMyFoodOrder_id=<%= Request.Params["uid"]%>' prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBoxScoreOfItem"
