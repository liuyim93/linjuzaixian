<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pAddOrderOfCommodity.aspx.cs" Inherits="Friday.mvc.weblogin.orderOfCommodity.pAddOrderOfCommodity" %>
    ...
    <form id="form" method="post" class="pageForm required-validate" enctype="multipart/form-data" runat="server">
        ...
        <div defh="95">
            ...
            <p>
                ...
                <a class="btnLook" href="commodity/ListCommodityByShop.aspx?shop_id=<%=Request.Params["shop_id"]%>" rel="" lookupgroup="">选择商品</a>
            </p>
            <p>
            <label>
                    商品单价:</label>
