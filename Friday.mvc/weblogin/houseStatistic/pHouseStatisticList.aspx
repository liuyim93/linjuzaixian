<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pHouseStatisticList.aspx.cs" Inherits="Friday.mvc.weblogin.houseStatistic.pHouseStatisticList" %>
        ...
        <asp:repeater id="repeater" runat="server">
               ...
               <th width="10%" align="center">月</th>
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="houseStatistic/pHouseStatisticDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>'  target="ajax" rel_v3="jbsxBox3"><%#Eval("Id")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            //debugger
            o.find("#houseStatisticList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
