<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pValuingItemOfMyCommodityOrderList.aspx.cs" Inherits="Friday.mvc.weblogin.valuingItemOfMyCommodityOrder.pValuingItemOfMyCommodityOrderList" %>
...
<div class="panelBar">
    <ul class="toolBar">
        ...
        <li id="liDelete" runat="server"><a class="delete" href="valuingItemOfMyCommodityOrder/pValuingItemOfMyCommodityOrderList.aspx?flag=alldelete&uid={id}"
            target="ajaxTodo" title="确定要删除吗?"><span>删除商品评价项</span></a></li>
        <li class="line">line</li>
    </ul>
</div>
<div id="ValuingItemOfMyCommodityOrderList">
