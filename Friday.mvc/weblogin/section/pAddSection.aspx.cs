...
{
    public partial class pAddSection : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["__EVENTVALIDATION"] != null)
            {
                ...
                {
                    Section category = iSectionService.Load(dic.ParentID);
