<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pAddValuingOfMyCommodityOrder.aspx.cs" Inherits="Friday.mvc.weblogin.valuingOfMyCommodityOrder.pAddValuingOfMyCommodityOrder" %>
    ...
    <div class="panel collapse" defh="95">
        ...
        <div>
             <p>
                ...
                <a class="btnLook" href="ListMyCommodityOrder.aspx" rel="" lookupgroup="">选择订单</a>
            </p>

            <p>
                <label>
                    下单时间：</label>
                <input type="text" id="OrderCreateTime" size="30" class="required  textInput gray" runat="server" />
            </p>
