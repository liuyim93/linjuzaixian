<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pValuingOfMyCommodityOrderList.aspx.cs" Inherits="Friday.mvc.weblogin.valuingOfMyCommodityOrder.pValuingOfMyCommodityOrderList" %>
...
<div class="panelBar">
    <ul class="toolBar">
        <li id="liAdd" runat="server"><a class="add" href="valuingOfMyCommodityOrder/pAddValuingOfMyCommodityOrder.aspx" title="添加商品订单评价" target="navTab" rel=""><span>
            添加商品订单评价</span></a></li>
        <li  id="liEdit" runat="server"><a class="edit" href="valuingOfMyCommodityOrder/pEditValuingOfMyCommodityOrder.aspx?uid={id}" title="修改商品订单评价" rel="" target="navTab">
            <span>修改商品订单评价</span></a></li>
        <li id="liDelete" runat="server"><a class="delete" href="valuingOfMyCommodityOrder/pValuingOfMyCommodityOrderList.aspx?flag=alldelete&uid={id}"
            target="ajaxTodo" title="确定要删除吗?"><span>删除商品订单评价</span></a></li>
        <li class="line">line</li>
    </ul>
</div>
<div id="ValuingOfMyCommodityOrderList">
    <table class="table" layouth="440">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="valuingOfMyCommodityOrder/pValuingOfMyCommodityOrderDetail.aspx?uid=<%#Eval("Id")%>&MyCommodityOrderId=<%#Eval("MyCommodityOrder.Id")%>" target="ajax" prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox3"><%#Eval("MyCommodityOrder.OrderNumber")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            //debugger
            o.find("#ValuingOfMyCommodityOrderList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
