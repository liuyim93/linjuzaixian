<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pValuingOfMyHouseOrderDetail.aspx.cs" Inherits="Friday.mvc.weblogin.valuingOfMyHouseOrder.pValuingOfMyHouseOrderDetail" %>
    ...
    <div class="tabsHeader">
        <div class="tabsHeaderContent">
          <ul>
                ...
                <li><a href='orderOfHouse/pOrderOfHouseList.aspx?myHouseOrder_id=<%= Request.Params["MyHouseOrderId"]%>' prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox1"
                target="ajax"><span>订单明细</span></a></li>
                <li><a href='scoreOfItemInHouseOrder/pScoreOfItemInHouseOrderList.aspx?valuingOfMyHouseOrder_id=<%= Request.Params["uid"]%>' prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBoxScoreOfItem"
