<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pEditAddress.aspx.cs" Inherits="Friday.mvc.weblogin.address.pEditAddress" %>
...
<div class="page">
    <div class="pageContent">
        ...
        <div class="pageFormContent" layoutH="80px" style="">
            <h1>
                配送地址基本信息</h1>
            <input type="hidden" id="AddressId" size="30" runat="server" />
             <p>
                <label>
                    配送地址：</label>
