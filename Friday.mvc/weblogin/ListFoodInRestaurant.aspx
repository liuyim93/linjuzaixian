<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListFoodInRestaurant.aspx.cs" Inherits="Friday.mvc.weblogin.ListFoodInRestaurant" %>
    ...
    <table class="table" layouth="200">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="userid" rel="<%#Eval("Id")%>">
                     ...
                     <td>
					<a class="btnSelect" href=javascript:$.bringBack({FoodRestID:'<%#DataBinder.Eval(Container.DataItem,"Id")%>',FoodRest:'<%#DataBinder.Eval(Container.DataItem,"Name")%>',Amount:'',Price:'',OnePrice:'<%#DataBinder.Eval(Container.DataItem,"Price")%>'}) title="查找带回">选择</a>
				</td>				
		        </tr>
            </ItemTemplate>
        </asp:repeater>
