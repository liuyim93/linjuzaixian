...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
         <li><a class="add"  href="nShopAdd.aspx"  title="添加商铺" target="navTab" rel="">
                <span>添加</span></a></li> 
    ...
    <table class="table" layouth="400">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="shop/nShopDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>' target="ajax" rel-v3="jbsxBox"><%#Eval("Id")%>
                            </a>
                        </td>
