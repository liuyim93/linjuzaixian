    ...
    <div class="panel collapse">
        ...
        <div>
                ...
                function shopPreviewImage(file) {
                    ...
                    //如果是IE浏览器，采用滤镜效果，进行显示，但特别注意的是该滤镜效果使用的对象是div对象，并非img对象，因此我们需要将原有的img对象remove同时生成新的div对象，并且赋值相应的class和id  
                        ...
                        $(ieImageDom).css({
                            ...
                            width: '90px',
                            height: '45px'
                        }).attr({ "id": "Edit_Shop_ImagePreview" });
                        //删除原有img对象，append创建div的dom对象  
                        $(ieImageDom).insertAfter("#Edit_Shop_Image");
                        porImg.remove();
                        //采用滤镜效果生成图片预览  
                        file.select();
            ...
            <p style="height: 120px">
                <label>
                    Logo上传：</label>
                <input id="Edit_Shop_Image" type="file" class="required textInput gray"   runat="server" onchange="shopPreviewImage(this);"/>
                <img  id="Edit_Shop_ImagePreview" runat="server" style="margin:10px;width: 90px; height: 45px" />
