<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pRentStatisticList.aspx.cs" Inherits="Friday.mvc.weblogin.rentStatistic.pRentStatisticList" %>
               ...
               <th width="10%" align="center">月</th>
                      <th width="10%" align="center">日</th>     
                        ...
                        <th width="10%" align="center">平均分</th>
                          <th width="10%" align="center">租房公司</th>
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="rentStatistic/pRentStatisticDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>'  target="ajax" rel_v3="jbsxBox3"><%#Eval("Id")%>
                            </a>
                        </td>
                  ...
                  <%--   <td align="center"><%#DataBinder.Eval(Container.DataItem, "Rent.Rent.Name")%></td>--%>                 
				</tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            //debugger
            o.find("#rentStatisticList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
