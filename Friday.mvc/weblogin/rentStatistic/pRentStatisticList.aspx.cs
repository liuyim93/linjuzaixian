...
{
    public partial class pRentStatisticList : BasePage
    {
       ...
       IRentStatisticService iRentStatisticService = UnityHelper.UnityToT<IRentStatisticService>();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request.Params["flag"] != "alldelete")
            {
                if (Request.Params["flag"] != "alldelete")
                {
                    ...
                    IList<RentStatistic> rentStatisticList = iRentStatisticService.Search(filterList, start, limit, out total);

                    repeater.DataSource = rentStatisticList;
                    repeater.DataBind();
        ...
        private void DeleteRentStatistic()
        {


            iRentStatisticService.Delete(Request.Params["uid"]);
