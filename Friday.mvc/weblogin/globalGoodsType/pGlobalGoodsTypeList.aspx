    ...
    <table class="table" layouth="440">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="globalGoodsType/pGlobalGoodsTypeDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>' target="ajax" rel_v3="jbsxBox3"><%#Eval("GoodsType")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            debugger
            o.find("#GlobalGoodsTypeList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
