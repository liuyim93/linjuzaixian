<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pGlobalGoodsTypeList.aspx.cs" Inherits="Friday.mvc.weblogin.pGlobalGoodsTypeList" %>
...
<div class="panelBar">
    <ul id="dictreeToolBar" class="toolBar">
        <li><a id="addata" class="add" href="globalGoodsType/pAddGlobalGoodsType.aspx?flag=save&code=" target="dialog" rel=""><span>添加</span></a></li>
        <li id="liDelete" runat="server"><a class="delete" href="globalGoodsType/pGlobalGoodsTypeList.aspx?flag=alldelete&code=" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            var node_click_url = "globalGoodsType/pEditGlobalGoodsType.aspx";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    //d.url = "globalGoodsType/pGlobalGoodsTypeList.aspx/GetGlobalGoodsType?t=" + (new Date().getTime());
