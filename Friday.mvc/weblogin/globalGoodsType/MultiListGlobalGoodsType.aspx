<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiListGlobalGoodsType.aspx.cs"
    Inherits="Friday.mvc.weblogin.MultiListGlobalGoodsType" %>
        ...
        <table class="searchContent">
            <tr>
                <td>
                    <label>
                        名称:</label>
                    <input type="text" name="GoodsType" class="textInput" value="<%=goodsType %>" value="" />
                </td>
                <td>
        ...
        <asp:repeater id="repeater" runat="server">
                 ...
                 <ItemTemplate> 
                    <tr target="userid" rel="<%#Eval("Id")%>">
                     <td><input type="checkbox" name="ids" value={IDSet:'<%#DataBinder.Eval(Container.DataItem,"Id")%>',NameSet:'<%#DataBinder.Eval(Container.DataItem,"GoodsType")%>'} /></td>
                     <td><%#Container.ItemIndex+1%></td>
					 <td><%#DataBinder.Eval(Container.DataItem, "GoodsType")%></td>			
			</tr>
                </ItemTemplate>
         </asp:repeater>
        </tbody>
