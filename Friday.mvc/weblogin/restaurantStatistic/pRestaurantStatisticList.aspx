<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pRestaurantStatisticList.aspx.cs" Inherits="Friday.mvc.weblogin.restaurantStatistic.pRestaurantStatisticList" %>
...
<div id="restaurantStatisticList">
        ...
        <asp:repeater id="repeater" runat="server">
               ...
               <th width="10%" align="center">月</th>
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="restaurantStatistic/pRestaurantStatisticDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>'  target="ajax" rel_v3="jbsxBox3"><%#Eval("Id")%>
                            </a>
                        </td>
                  ...
                  <%--   <td align="center"><%#DataBinder.Eval(Container.DataItem, "Restaurant.Restaurant.Name")%></td>--%>                 
				</tr>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            //debugger
            o.find("#restaurantStatisticList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
