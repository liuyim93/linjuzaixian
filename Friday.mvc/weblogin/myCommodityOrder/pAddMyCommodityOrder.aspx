<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pAddMyCommodityOrder.aspx.cs" Inherits="Friday.mvc.weblogin.pAddMyCommodityOrder" %>
        ...
        <div>
            <p>
             ...
             <p id="addOrdMerchant" runat=server>
                ...
                <a class="btnLook" href="ListMerchantByMerchantType.aspx?MerchantType=商店" rel="" lookupgroup="">选择商铺</a>
            </p>
