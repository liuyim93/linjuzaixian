<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pAddScoreOfItemInFoodOrder.aspx.cs" Inherits="Friday.mvc.weblogin.scoreOfItemInFoodOrder.pAddScoreOfItemInFoodOrder" %>
    ...
    <form id="form" method="post" class="pageForm required-validate" enctype="multipart/form-data" runat="server">
        ...
        <div defh="95">
            ...
            <p>
                ...
                <a class="btnLook" href="ListValuingItemOfMyFoodOrder.aspx" rel="" lookupgroup="">选择评价项</a>
            </p>
            <p>
            <label>
                    评分:</label>
