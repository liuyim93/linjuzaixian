...
{
    public partial class pShopEmployeeList : System.Web.UI.Page
    {
        ...
        {
            string shopEmployeeid = Request.Params["shopEmployeeid"];

            iLoginUserRepository.Delete(shopEmployeeid);
