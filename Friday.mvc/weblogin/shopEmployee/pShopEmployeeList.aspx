<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pShopEmployeeList.aspx.cs" Inherits="Friday.mvc.weblogin.pShopEmployeeList" %>
...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="add" href="shopEmployee/pAddShopEmployee.aspx?merchant_id={id}" title="增加员工" target="dialog"
            rel="" width="600" height="400"><span>增加员工</span></a></li>
        <li><a class="edit" href="shopEmployee/pEditShopEmployee.aspx?shopEmployeeid={shopEmployee_id}" title="修改员工" rel="" target="dialog"
            height="480"><span>修改员工</span></a></li>
        <li><a class="delete" href="shopEmployee/pShopEmployeeList.aspx?flag=alldelete&shopEmployeeid={shopEmployee_id}" target="ajaxTodo"
            title="确定要删除吗?"><span>删除员工</span></a></li>
        <li class="line">line</li>
    </ul>
</div>
<div id="shopEmployeeList">
        ...
        <asp:repeater id="repeater" runat="server">
              <HeaderTemplate>
                 ...
                 <ItemTemplate> 
                    ...
                    <tr target="shopEmployee_id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
...
<div class="panelBar">
    ...
    <div class="pagination" rel="<%=Request.Params["rel_v3"] %>" totalcount="<%=total %>"
        numperpage="<%=numPerPage.Value %>" curshoppage="<%=pageNum %>">
    </div>
</div>
