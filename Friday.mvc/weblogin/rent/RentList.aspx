<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RentList.aspx.cs" Inherits="Friday.mvc.weblogin.RentList" %>
<div class="pageContent">
    ...
    <a href='Rent/pRentList.aspx' prefix='<%=Request.Params["prefix"] %>'  rel-v3="jbsxBox2" target="ajax" style="display:none">load</a>
    ...
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="edit" href="nRentUpdate.aspx?uid={id}" title="修改商铺" rel="" target="navTab">
                <span>修改</span></a></li>
            <li><a class="delete" href="rent/pRentList.aspx?flag=alldelete&uid={id}"  target="ajaxTodo" title="确定要删除吗?" >
                <span>删除</span></a></li>
    ...
    <table class="table" layouth="400">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="rent/pRentDetail.aspx?uid=<%#Eval("Id")%>" prefix='<%=Request.Params["prefix"] %>' target="ajax" rel-v3="jbsxBox3"><%#Eval("Id")%>
                            </a>
                        </td>
