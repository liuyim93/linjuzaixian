<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pEditPropValue.aspx.cs" Inherits="Friday.mvc.weblogin.pEditPropValue" %>
    ...
    <div class="panel collapse" defh="95">
        ...
        <div>
               <p>
                <label>
                    所属规格：</label>
                  <input type="text" id="PropIDName" size="30" class="required textInput gray"  runat="server" />
