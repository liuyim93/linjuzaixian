<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pAnonymousUserList.aspx.cs" Inherits="Friday.mvc.weblogin.pAnonymousUserList" %>
    ...
    <table class="table" layouth="440">
        <asp:repeater id="repeater" runat="server">
                ...
                <tr target="id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                        ...
                        <td><a href="systemUser/pAnonymousUserDetail.aspx?uid=<%#Eval("Id")%>" target="ajax" prefix='<%=Request.Params["prefix"] %>' rel_v3="jbsxBox3"><%#Eval("LoginUser.LoginName")%>
                            </a>
                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            debugger
            o.find("#AnonymousUserList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
