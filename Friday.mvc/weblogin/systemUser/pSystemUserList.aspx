<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pSystemUserList.aspx.cs" Inherits="Friday.mvc.weblogin.pSystemUserList" %>
...
<div class="panelBar">
    <ul class="toolBar">
        ...
        <li id="liEdit" runat="server"><a class="edit" href="systemUser/pEditSystemUser.aspx?uid={id}" title="修改用户" rel="" target="navTab">
            <span>修改用户</span></a></li>
        <li id="liReset" runat="server"><a class="delete" href="systemUser/pResetSystemUserPassword.aspx?uid={id}" title="密码重置" rel="" target="navTab">
        <span>密码重置</span></a></li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $(document).one("panelloaded", function (e, o) {
            ...
            debugger
            o.find("#SystemUserList table:eq(1) tr").click(function (e) {
                if (!$(e.target).is("a")) {
