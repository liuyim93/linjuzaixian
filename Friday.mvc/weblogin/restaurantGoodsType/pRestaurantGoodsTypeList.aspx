<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pRestaurantGoodsTypeList.aspx.cs" Inherits="Friday.mvc.weblogin.pRestaurantGoodsTypeList" %>
            ...
            <tbody>
                <tr>
                    <td>
                        <label>
                            名称:</label>
                        <input id="GoodsType" type="text" name="Name" value="<%=name%>" />
                    </td>
                    <td>
...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="add" href="RestaurantGoodsType/pAddRestaurantGoodsType.aspx?merchant_id={id}" title="增加菜品" target="dialog"
            rel="" width="600" height="400"><span>增加菜品</span></a></li>
        <li><a class="edit" href="RestaurantGoodsType/pEditRestaurantGoodsType.aspx?uid={restaurantGoodsTypeid}&merchant_id={id}" title="修改菜品" rel="" target="dialog"
            height="480"><span>修改菜品</span></a></li>
        <li><a class="delete" href="RestaurantGoodsType/pRestaurantGoodsTypeList.aspx?flag=alldelete&restaurantGoodsType_id={restaurantGoodsTypeid}" target="ajaxTodo"
            title="确定要删除吗?"><span>删除菜品</span></a></li>
        <li class="line">line</li>
    </ul>
</div>
<div id="restaurantGoodsTypeList">
              ...
              <HeaderTemplate>
                      <thead>
                        <tr>
                            ...
                            <th width="20%" orderField="GoodsType" class="asc" align="center">名称</th>
                 ...
                 <ItemTemplate> 
                    ...
                    <tr target="restaurantGoodsTypeid" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
                         <td align="center"><%#Container.ItemIndex+1%></td> 
                         <td align="center"><%#DataBinder.Eval(Container.DataItem, "GoodsType")%></td> 
