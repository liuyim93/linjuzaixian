<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pRentEmployeeList.aspx.cs" Inherits="Friday.mvc.weblogin.pRentEmployeeList" %>
...
<%--<input type="hidden" name="rent_id" value="<%=Request.Params["rent_id"] %>" />--%>
</form>
...
<div class="panelBar">
    <ul class="toolBar">
        <li><a class="add" href="rentEmployee/pAddRentEmployee.aspx?merchant_id={id}" title="增加员工" target="dialog"
            rel="" width="600" height="400"><span>增加员工</span></a></li>
        <li><a class="edit" href="rentEmployee/pEditRentEmployee.aspx?rentEmployeeid={rentEmployee_id}" title="修改员工" rel="" target="dialog"
            height="480"><span>修改员工</span></a></li>
        <li><a class="delete" href="rentEmployee/pRentEmployeeList.aspx?flag=alldelete&rentEmployeeid={rentEmployee_id}" target="ajaxTodo"
            title="确定要删除吗?"><span>删除员工</span></a></li>
        <li class="line">line</li>
    </ul>
</div>
<div id="rentEmployeeList">
        ...
        <asp:repeater id="repeater" runat="server">
              <HeaderTemplate>
                 ...
                 <ItemTemplate> 
                    ...
                    <tr target="rentEmployee_id" rel="<%#Eval("Id")%>&discriminer=<%#Eval("Id")%>">
