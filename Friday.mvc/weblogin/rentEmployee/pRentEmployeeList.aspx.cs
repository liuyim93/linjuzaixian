...
{
    public partial class pRentEmployeeList : System.Web.UI.Page
    {
        ...
        {
            string rentEmployeeid = Request.Params["rentEmployeeid"];

            iLoginUserRepository.Delete(rentEmployeeid);
