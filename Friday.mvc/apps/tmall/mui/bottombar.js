...
KISSY.add("tmall/mui/bottombar", function (_kissy_imp, _dom, _event) {
    ...
    return _kissy_imp["tmall/mui/bottombar"] = _kissy_imp["tmall/mui/bottombar"] || { add: function (_dom_div_id_J_BrandBar, _options) {
        if (!_table_snippet) {
            _create_bottom_bar()
        }
        _options = _options || {};
