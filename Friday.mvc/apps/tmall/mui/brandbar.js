KISSY.add("tmall/mui/brandbar", function (_kissy_tmp, _dom, _event) {
        ...
        var BrandBar = { show: function (_opts) {
            ...
            _options.success = function (Q) {
                ...
                _kissy_tmp.use("tmall/mui/brandbar-fly", function (T, R) {
            ...
            _kissy_tmp.use("tmall/mui/brandfollow", function (_kissy, _brandfollow) {
                _brandfollow.add(_brandid, _options)
            })
        }
        };
        _kissy_tmp.mix(BrandBar, _kissy_tmp.EventTarget);
        return _kissy_tmp["tmall/mui/brandbar"] = _kissy_tmp["tmall/mui/brandbar"] || BrandBar
    }, { requires: ["dom", "event"] })
