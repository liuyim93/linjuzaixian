...
(function (E) {
    ...
    C.use(B, function (I) {
        KISSY.add("TMiniCartModel", function (O) {
            var W = location.hostname.indexOf(".net") != -1,
                 ...
                 X = J = Q = P = "http://120.192.31.164:7525/",
                 L = {
        ...
        KISSY.add("TMiniCartView", function (w) {
            ...
            function Ag(An) {
                ...
                function Ap(Aq, At) {
                    ...
                    w.onTgalleryReady ? Ar() : w.getScript("http://120.192.31.164:7525/apps/tmall/common/tgallery.js?t=" + w.configTgallery.tag, Ar)
                }
                var Ao = AG.create(S);
    ...
    function D(K) {
        ...
        if (!I) {
            ...
            KISSY.getScript("http://120.192.31.164:7525/apps/tmall/tml/1.0/tml/minilogin.js?t=20121022", function () {
