...
//          V = "http://img0" + T + ".taobaocdn.com/" + (U || "tps") + "/i" + T + "/" + V
    ...
    var F = {
        init: function () {
            ...
            a.container.innerHTML = '<div class="hd"><h2><span>LJZX</span></h2><ul class="recommendNav"><li data-idx="0" class="' + D + '">\u6700\u7545\u9500\u7684\u5546\u54C1</li><li data-idx="1" class="' + L + '">\u6700\u65B0\u4E0A\u67B6\u7684\u5546\u54C1</li><li data-idx="2" class="' + E + '">\u60a8\u53ef\u80fd\u611f\u5174\u8da3\u7684\u5546\u54c1</li><li data-idx="3" class="' + J + '">\u70ed\u5356\u5546\u54c1</li><li data-idx="4" class="' + P + '">\u4fc3\u9500\u4e2d\u7684\u5546\u54c1</li></ul></div><div class="bd"><div class="recommendCont ' + D + '"></div><div class="recommendCont ' + L + '"></div><div class="recommendCont ' + E + '"></div><div class="recommendCont ' + J + '"></div><div class="recommendCont ' + P + '"></div></div>';
            a.carousels = [];
