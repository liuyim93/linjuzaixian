        ...
        */
        ...
        _tb_global.loginStatusReady(function (_user_info) {
            ...
            if (_user_info.isLogin) {
                ...
                _user_info_snippet = 'HI,<a target="_top" href="' + _spaceserver + '" class="j_UserNick sn-user-nick">' + _user_info.nick + '</a>\uff01<a class="j_Identity sn-identity hidden" target="_top"></a><span class="j_Message sn-message hidden"><a target="_top" href="http://localhost:7525/index.html" class="j_MessageText">消息<em class="j_MessageNum sn-msg-num">0</em></a><span class="sn-msg-box  j_MesssageBox hidden"><i class="sn-msg-hd"></i></span></span><a class="sn-logout" target="_top" href="' + _logoutserver + '" id="J_Logout">退出</a><i class="sn-separator"></i>';
