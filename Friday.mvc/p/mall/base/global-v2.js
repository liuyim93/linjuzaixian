...
TB.add("mod~global", function () {
    ...
    //_own_domain = _is_own ? ".daily.taobao.net" : ".taobao.com";
        _own_domain = _is_own ? "www.linjuzaixian.com" : ".taobao.com";
    //var g = _is_own ? "assets.daily.taobao.net" : "a.tbcdn.cn",
    var _own_domain_1 = _is_own ? "www.linjuzaixian.com" : "a.tbcdn.cn",
...
//            _member_url = "http://tmm.daily.taobao.net/member/query_member_top.do"
    ...
    TB.Cart = _kissy.merge({},
               {
                   domain: (document.domain.indexOf("taobao.com") > -1 || document.domain.indexOf("tmall.com") > -1) ? "taobao.com" : "www.linjuzaixian.com",
